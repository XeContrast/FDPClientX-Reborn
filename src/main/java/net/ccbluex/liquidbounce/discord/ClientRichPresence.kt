...
class ClientRichPresence : MinecraftInstance() {
    ...
    private var clientID = 750705612706283520
    ...
    fun update() {
        ...
        if (assets.containsKey("auto"))
                builder.setLargeImage(assets["auto"], "Using Badlion Client Minecraft Launcher")
                builder.setDetails("Playing Minecraft 1.12.2")
