...
object ClassProviderImpl : IClassProvider {
    ...
    override fun isCPacketInput(obj: Any?): Boolean = obj is PacketImpl<*> && obj.wrapped is CPacketInput
    ...
    override fun isSPacketKeepAlive(obj: Any?): Boolean = obj is PacketImpl<*> && obj.wrapped is SPacketKeepAlive
    ...
    override fun createSafeVertexBuffer(vertexFormat: IVertexFormat): IVertexBuffer = SafeVertexBuffer(
        vertexFormat.unwrap()
    ).wrap()
