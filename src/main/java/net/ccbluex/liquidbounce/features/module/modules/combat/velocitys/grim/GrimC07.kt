...
class GrimC07 : VelocityMode("GrimC07") {
    ...
    private val sendC03Value =
        BoolValue("${valuePrefix}SendC03", false).displayable { false } // bypass latest but flag timer

    private val C06Value =
        BoolValue("${valuePrefix}Send1.17C06", false).displayable { sendC03Value.get() } // need via to 1.17+
