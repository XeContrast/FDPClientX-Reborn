...
object Wings : Module() {
    ...
    val CR = IntegerValue("R", 255, 0, 255) { ColourType.get() == "Custom" }
    val CG = IntegerValue("G", 255, 0, 255) { ColourType.get() == "Custom" }
    val CB = IntegerValue("B", 255, 0, 255) { ColourType.get() == "Custom" }
