...
class VulcanHopSpeed : SpeedMode("VulcanHop") {
    ...
    override fun onUpdate() {
        ...
        if ((RotationUtils.targetRotation == null && abs(mc.thePlayer.moveStrafing) < 0.1) || (RotationUtils.targetRotation != null && abs(RotationUtils.getAngleDifference(MovementUtils.movingYaw, RotationUtils.targetRotation!!.yaw)) < 45.0f)) {
