...
object Crosshair : Module() {
    ...
    private val colorRedValue = IntegerValue("Red", 255, 0, 255) { colorModeValue.equals("Custom") }
    private val colorGreenValue = IntegerValue("Green", 255, 0, 255) { colorModeValue.equals("Custom") }
    private val colorBlueValue = IntegerValue("Blue", 255, 0, 255) { colorModeValue.equals("Custom") }
    private val colorAlphaValue = IntegerValue("Alpha", 255, 0, 255)

    // Rainbow thingy
    private val saturationValue = FloatValue("Saturation", 1f, 0f, 1f) { colorModeValue.equals("Slowly") }
    private val brightnessValue = FloatValue("Brightness", 1f, 0f, 1f) { colorModeValue.equals("Slowly") }
