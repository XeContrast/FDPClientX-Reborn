...
class MatrixClipFly : FlyMode("MatrixClip") {
    ...
    private val clipSmart = BoolValue("${valuePrefix}Clip2-SmartClip", true) { clipMode.equals("Clip2") }
    private val customClip = IntegerValue("${valuePrefix}Custom-ClipDelay",736,500,1500) { clipMode.equals("CustomClip") }
    private val customBlink = IntegerValue("${valuePrefix}Custom-BlinkDelay",909,500,1500) { clipMode.equals("CustomClip") }
