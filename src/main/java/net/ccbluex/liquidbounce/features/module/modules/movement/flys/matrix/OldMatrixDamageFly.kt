...
class OldMatrixDamageFly : FlyMode("OldMatrixDamage") {
    ...
    private val timer = FloatValue("${valuePrefix}Timer", 1.0f, 0f, 2f) { mode.equals("Custom") }
    private val speedBoost = FloatValue("${valuePrefix}Custom-BoostSpeed", 0.5f, 0f, 3f) { mode.equals("Custom") }
    private val boostTicks = IntegerValue("${valuePrefix}Custom-BoostTicks", 27,10,40) { mode.equals("Custom") }
    private val randomize = BoolValue("${valuePrefix}Custom-Randomize", true) { mode.equals("Custom") }
    private val randomAmount = IntegerValue("${valuePrefix}Custom-RandomAmount", 1, 0, 30) { mode.equals("Custom") }
    private val customstrafe = BoolValue("${valuePrefix}Custom-Strafe", true) { mode.equals("Custom") }
