...
object ChestAura : Module() {
    ...
    private var camYaw = currentBlock
    private var camPitch = currentBlock
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (event.eventState == EventState.PRE) {
            ...
            currentBlock = BlockUtils.searchBlocks(radius.toInt(), null)
                .filter {
            ...
            if (rotationsValue.get()) {
                if (!legitrotations.get()) {
                    ...
                    Rotation(
                        RotationUtils.faceBlock(currentBlock ?: return)!!.rotation.yaw, RotationUtils.faceBlock(
                            currentBlock ?: return)!!.rotation.pitch).toPlayer(mc.thePlayer)
                }
            }
