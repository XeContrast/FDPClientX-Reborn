...
open class ModuleElement(val module: Module): MinecraftInstance() {
    ...
    companion object {
        protected val expandIcon = IconManager.expand }
...
//        RoundedRectShader.draw(x + 9.5F, y + 4.5F, x + width - 9.5F, y + height + animHeight - 4.5F, 4F, ColorManager.buttonOutline)
        Stencil.write(true)
        RenderUtils.drawRoundedRect(x + 10F, y + 5F, x + width - 10F, y + height + animHeight - 5F, 4F, ColorManager.moduleBackground)
        Stencil.erase(true)
        ...
        RenderUtils.drawRoundedRect(
                ...
                x + 35F + Fonts.font40.getStringWidth(module.name) + Fonts.fontTiny.getStringWidth(keyName),
                y + height / 2F, 2F,
            BlendUtils.blend(Color(4282729797L.toInt()), Color(4281677109L.toInt()), fadeKeybind.toDouble())!!
        )
