...
class Statistics(
    ...
    private val mode = ListValue("Mode", arrayOf("CrossSine", "FDP", "Moon"), "FDP")
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if (mode.equals("Moon")) {
            ...
            //bg
            RenderUtils.drawRoundedRect(0F, 0F, 120F, 120F, 10F,Color(0,0,0,100).rgb, 2.5F,
                Color(0, 0, 0, 100).rgb)
            font.drawStringWithShadow("Session Information",60f,5f,Color.WHITE.rgb)
