...
class RiseTH(inst: Targets) : TargetStyle("Rise", inst, true) {
    ...
    override fun drawTarget(entity: EntityLivingBase) {
        ...
        Stencil.erase(true)
        drawHead(entity.skin, -2, -3, 35, 35, Color(255,255,255,fadeAlpha(255)).rgb.toFloat())
        Stencil.dispose()
        GL11.glPopMatrix()
        ...
        font.drawString("Name: ${entity.name}", 45, 14, Color(rainbow().red, rainbow().green, rainbow().blue, rainbow().alpha).rgb)
        ...
        RenderUtils.drawRoundedCornerRect(50f, 31f, 50f + (healthBarWidth * (easingHealth / entity.maxHealth)) , 39f, 4f, Color(rainbow().red, rainbow().green, rainbow().blue, rainbow().alpha).rgb)
        ...
        font.drawString(getHealth(entity).roundToInt().toString(), ((38 + additionalWidth - font.getStringWidth((getHealth(entity) * 1.15).roundToInt().toString())) / 1.15).roundToInt()   , 29 - (font.FONT_HEIGHT/2),  Color(rainbow().red, rainbow().green, rainbow().blue, rainbow().alpha).rgb)
        GL11.glPopMatrix()
    }
