...
class CrossSineTH(inst: Targets) : TargetStyle("CrossSine", inst, true) {
    override fun drawTarget(entity: EntityLivingBase) {
        ...
        RenderUtils.drawRoundedRect(0F,0F, 70F + leagth, 42F, 4F, Color(0,0,0,fadeAlpha(80)).rgb, 2F,
            Color(100, 255, 255,255).rgb)
        RenderUtils.drawRoundedGradientRectCorner(50F, 32F, 52F +  ((8F + leagth) * easingHealth / 20),37F, 2F,
            Color(100, 255, 255,255).rgb,
    ...
    override fun getBorder(entity: EntityLivingBase?): Border {
        val entityNameWidth = if (entity != null) Fonts.SF.getStringWidth(entity.name) else 0
